...
/**
 * Explicit input type for the PATCH /evaluations upsert operation.
 * Uses Pick rather than CreateInput<Evaluation> to enumerate caller-supplied
 * fields explicitly — immune to future additions to the Evaluation interface.
 * id and updatedAt are always generated by the service, never by the caller.
 */
export type UpsertEvaluationInput =
  Pick<Evaluation, 'studentId' | 'classId' | 'goal' | 'concept'>;
